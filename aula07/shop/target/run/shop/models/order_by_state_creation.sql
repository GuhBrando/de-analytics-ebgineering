  ...
  create or replace view `weighty-legend-382122`.`shop_queries`.`order_by_state_creation`
  OPTIONS()
  as SELECT custumers_dataset.customer_state, count(orders_dataset.order_id) as total
